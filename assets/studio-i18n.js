...
(function () {
  ...
  var MAP = {
    ...
    '验证码无效或已过期；尝试次数过多时，请一小时后重新获取。': 'The code is invalid or expired. After too many attempts, request a new code in one hour.',
    '我同意': 'I agree to the', '，并已阅读': 'and have read the',
    '请同意服务条款，并确认已阅读隐私政策。': 'Please agree to the Terms of Service and acknowledge reading the Privacy Policy.',
    '政策已更新，请阅读当前版本后重新确认。': 'The policies have changed. Please read and confirm the current version.',
    '注册信息暂时无法读取，请稍后重试。': 'Registration information is unavailable. Please try again shortly.',
    '服务政策更新': 'Updated service policies', '确认当前政策': 'Confirm current policies', '政策确认已保存。': 'Your policy confirmation has been saved.',
    '认证服务暂时繁忙，请稍后重试。': 'Sign-in services are temporarily busy. Please try again shortly.',
    '请求来源不受信任。': 'This request came from an untrusted origin. Please reopen the official website.',
    '请求过于频繁，请稍后再试。': 'Too many requests. Please try again later.',
    '请求暂时无法处理，请稍后重试。': 'This request cannot be processed right now. Please try again later.',
    '请求格式不正确。': 'The request format is invalid.', '服务暂时无法处理请求。': 'The service cannot process this request right now.',
    ...
    '动态验证码或恢复码': 'Authenticator code or recovery code',
    '管理双重认证': 'Manage two-factor authentication',
    '请输入验证器动态码或恢复码。': 'Enter your authenticator code or a recovery code.',
    '验证码无效或已使用，请使用新验证码或恢复码。': 'Invalid or already used code. Enter a new code or a recovery code.',
    '验证尝试过多，请 15 分钟后重试。': 'Too many verification attempts. Try again in 15 minutes.',
    '管理员尚未绑定验证器，请联系系统运营者完成设置。': 'Administrator setup is incomplete. Contact the site operator to enroll an authenticator.',
    '邮箱已验证，请使用密码和动态码登录。': 'Email verified. Sign in with your password and authenticator code.',
    ...
    '退款说明': 'Refund Policy', '联系支持': 'Contact Support', '政策中心与版本': 'Policies and Versions',
